...
urlpatterns = [
    ...
    url(r"^email_address_verify/(?P<key>\w+)/$", views.email_address_verify_single_page, name="account_email_verify"),

    url(r"^email_unsubscribe/(?P<key>\w+)/$", views.email_unsubscribe_single_page, name="email_unsubscribe"),
