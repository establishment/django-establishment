define(["exports", "katex_functions", "katex_environments", "katex_Lexer", "katex_symbols", "katex_utils", "katex_parseData", "katex_ParseError"], function(exports, functions, environments, Lexer, symbols, utils, parseData, ParseError) {

    function Parser(input, settings) {
        // Make a new lexer
        this.lexer = new Lexer.Lexer(input);
    ...
    Parser.prototype.handleInfixNodes = function(body) {
        ...
        for (var i = 0; i < body.length; i++) {
            ...
            if (node.type === "infix") {
                if (overIndex !== -1) {
                    throw new ParseError.ParseError("only one infix operator per group",
                        this.lexer, -1);
                }
                overIndex = i;
