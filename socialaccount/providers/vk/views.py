...
from establishment.socialaccount.providers.oauth2.views import OAuth2Adapter, OAuth2LoginView, OAuth2CallbackView
...
class VKOAuth2Adapter(OAuth2Adapter):
    ...
    def complete_login(self, request, app, token, **kwargs):
        ...
        return self.get_provider().social_login_from_response(request, extra_data)
